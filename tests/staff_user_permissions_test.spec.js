...
test.describe('staff_user_permissions_test', () => {
    ...
    test('Should create member record and assign it to the Staff role', { tag: [ '@regression', '@staging-correct' ] }, async ({ page, dataManager }) => {
        try {
    ...
    test('Verify permission of Staff role', { tag: [ '@regression', '@staging-correct' ] }, async ({ page, context, dataManager }) => {
        try {
