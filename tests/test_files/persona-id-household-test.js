/**
 * PERSONA_PAYLOAD mock data for Identity Verification in Household Tests
 * This payload simulates Persona identity verification responses
 * Used for testing co-applicant flag attribution and household status transitions
 */

/**
 * Generate PERSONA_PAYLOAD for Primary Applicant (Name Match - PASSES)
 * @param {Object} userData - User data with first_name, last_name, email
 * @returns {Object} PERSONA_PAYLOAD structure
 */
...
/**
 * Generate PERSONA_PAYLOAD for Co-Applicant with Name Mismatch (TRIGGERS FLAG)
